...
Logger log = Logger.getLogger(this.getClass().toString());
   ...
   //FileHandler fileHandler = new FileHandler("../Log/insert.log");
	 ...
	 //   log.addHandler(fileHandler);
       ...
       <%  request.setCharacterEncoding("UTF-8");
	    ...
	    if(request.getParameter("insert") != null){ 
	        String sql = "insert into send (c_id,youad,youad2,name,code) values (?,?,?,?,?)"; 
	        pstmt = conn.prepareStatement(sql); 
               if(youad.length()>19){
                  youad2=youad.substring(19,youad.length());
                }
                log.info("insert id="+c_id +" name="+name+" code="+code+" youad="+youad+" youad2="+youad2);
	...
	%> 
      ...
      <table class="table table-bordered table-striped">
    <thead>
    <center><b><tr><th>客戶代號</th><th>客戶名稱</th><th>郵遞區號</th><th>客戶地址</th></tr></b></center>
    </thead>
    <tbody id="myTable">
   <%     
       request.setCharacterEncoding("UTF-8");
       out.print("<tr><td> " + c_id + "</td><td>"+name+"</td><td> "+ code+"</td><td> " + youad + "</td></tr> "); 
       %>
